                ...
                <div class="row no-gutters">
                    <div class="col-lg-11 col-md-10 col-sm-9 col-9">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" th:href="@{/HTISchool-Software}">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{url('telDevoir')}}">Cours/Devoir</a>                                       
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{url('quizF')}}">Examen</a>                                       
                                    </li>
                                 
                                    <li class="nav-item">
                                        <a href="contact.html">Syllabus</a>
                                        <ul class="sub-menu">
                                       ...
                                       <li class="nav-item">
                                <a href="@{/login}"><i class="fa fa-user"></i> {{ Auth::user()->name }}<span style="color:#FFC107" ></span></a>
                                 <ul class="sub-menu">
                                            <li>
